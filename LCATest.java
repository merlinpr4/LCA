...
public class LCATest {
	...
	public void testLCA() {
		...
		assertEquals("LCA of 6 and 7 is 2",3, bt.findLCA(6,7));
		assertEquals("LCA of 2 and 4 is 2",2, bt.findLCA(2,4));
		assertEquals("LCA of 7 and 5 is 2",1, bt.findLCA(7,5));
	...
	public void testNonExistentNode() {
		...
		assertEquals("LCA of 5 and 2 is -1 (not existent)",-1, bt.findLCA(5,1));
	}
	...
	public void testNonExistentTree() {
		...
		assertEquals("LCA of 2 and 3 is -1 (not existent)",-1, bt.findLCA(1,5));
